...
LABEL org.opencontainers.image.title="omada-controller"\
 ...
 org.opencontainers.image.version="5.12.7"
...
RUN wget -q https://static.tp-link.com/upload/software/2023/202309/20230920/Omada_SDN_Controller_v5.12.7_Linux_x64.deb &&\
 apt-get -y install ./Omada_SDN_Controller_v5.12.7_Linux_x64.deb && tpeap stop && rm -f ./Omada_SDN_Controller_v5.12.7_Linux_x64.deb &&\
