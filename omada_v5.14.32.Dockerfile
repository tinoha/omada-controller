...
LABEL org.opencontainers.image.title="omada-controller"\
 ...
 org.opencontainers.image.version="5.14.32"
...
RUN apt-get -y update && apt-get -y upgrade && \
  ...
  apt-get update && \
  apt-get install -y mongodb-org=7.0.14 mongodb-org-database=7.0.14 mongodb-org-server=7.0.14 mongodb-mongosh mongodb-org-mongos=7.0.14 mongodb-org-tools=7.0.14 \
...
RUN  groupadd -g 550 omada && useradd -u 550 -g omada -d /opt/tplink/EAPController/data -s /usr/sbin/nologin -M omada && \
 curl -LO https://static.tp-link.com/upload/software/2024/202410/20241015/Omada_SDN_Controller_v5.14.32.2_linux_x64.deb && \
